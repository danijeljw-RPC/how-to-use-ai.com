...
- `docs/02-book-01/research/research-note-copilot-forced-ai.md` — the "hype vs. operational AI" contrast (§6.6 of that research note) is conceptually relevant and used generically as an idea (not cited as a source, not using its unverified statistics), consistent with that note's reliability caution
...
- `docs/02-book-01/plans/chapter-11-plan.md` (this file)
