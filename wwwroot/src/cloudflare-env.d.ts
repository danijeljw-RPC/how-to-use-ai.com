/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/cloudflare-env.d.ts` (hash: 9f44f5b0c7e8c1584a5c897de4af47da)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SITE_URL" | "COMMERCE_ENABLED">> {}
}
